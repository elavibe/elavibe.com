let tallPostIt = document.querySelectorAll("img");
let squarePostIt = document.querySelectorAll("img");
let widePostIt = document.querySelectorAll("img");
...
for (let tallPost of tallPostIt) {
  tallPost.addEventListener("click", () => {
    let randomPostitImage = "PostItTall" + randomNumber(112) + ".png";
    document.querySelectorAll("img")[0].setAttribute("src", randomPostitImage);
  });
}

for (let squarePost of squarePostIt) {
  squarePost.addEventListener("click", () => {
    let randomPostitImage = "PostItSquare" + randomNumber(49) + ".png";
    document.querySelectorAll("img")[1].setAttribute("src", randomPostitImage);
  });
}
for (let squarePost of squarePostIt) {
  squarePost.addEventListener("click", () => {
...
for (let tallPost of tallPostIt) {
  tallPost.addEventListener("click", () => {
    let randomPostitImage = "PostItTall" + randomNumber(112) + ".png";
    document.querySelectorAll("img")[3].setAttribute("src", randomPostitImage);
  });
}
for (let widePost of widePostIt) {
  widePost.addEventListener("click", () => {
    let randomPostitImage = "PostItWide" + randomNumber(86) + ".png";
    document.querySelectorAll("img")[4].setAttribute("src", randomPostitImage);
  });
}
for (let tallPost of tallPostIt) {
  tallPost.addEventListener("click", () => {
    let randomPostitImage = "PostItTall" + randomNumber(112) + ".png";
    document.querySelectorAll("img")[5].setAttribute("src", randomPostitImage);
    tallPost.addEventListener("dblclick", removeClassTall3);
  });
}
for (let widePost of widePostIt) {
  widePost.addEventListener("click", () => {
    let randomPostitImage = "PostItWide" + randomNumber(86) + ".png";
    document.querySelectorAll("img")[6].setAttribute("src", randomPostitImage);
  });
}
for (let tallPost of tallPostIt) {
  tallPost.addEventListener("click", () => {
    let randomPostitImage = "PostItTall" + randomNumber(112) + ".png";
    document.querySelectorAll("img")[7].setAttribute("src", randomPostitImage);
  });
}
...
for (let widePost of widePostIt) {
  widePost.addEventListener("click", () => {
    let randomPostitImage = "PostItWide" + randomNumber(86) + ".png";
    document.querySelectorAll("img")[8].setAttribute("src", randomPostitImage);
  });
}
for (let squarePost of squarePostIt) {
  squarePost.addEventListener("click", () => {
    let randomPostitImage = "PostItSquare" + randomNumber(49) + ".png";
    document.querySelectorAll("img")[9].setAttribute("src", randomPostitImage);
  });
}
for (let tallPost of tallPostIt) {
  tallPost.addEventListener("click", () => {
    let randomPostitImage = "PostItTall" + randomNumber(112) + ".png";
    document.querySelectorAll("img")[10].setAttribute("src", randomPostitImage);
  });
}
...
for (let squarePost of squarePostIt) {
  squarePost.addEventListener("click", () => {
    let randomPostitImage = "PostItSquare" + randomNumber(49) + ".png";
    document.querySelectorAll("img")[11].setAttribute("src", randomPostitImage);
  });
}
